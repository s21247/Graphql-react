...
import {favoritesItemAdded} from "../Features/favorites/favoritesSlice";
...
const StoreItem = ({id,image,name,description,price}: Product) => {
  ...
  const onClickAddFavoriteItem = () => {
      dispatch(favoritesItemAdded(id,image,name,description,price,true))
  }
  return (
    <>
      <img
      ...
      <div className="pt-3 flex items-center justify-between">
        <p className="text-base">{name}</p>
          <button onClick={onClickAddFavoriteItem}>
        <svg
