...
const ChangeAddress = ({open,handleChange,shipping, selectChange,canSave}: props) => {
    if(!open) return null
    return (
        <div className="flex flex-col w-full items-center mb-4">
            ...
            <input
                ...
                maxLength={5}
            />
            <button disabled={!canSave} className="py-4 w-full bg-black text-white mt-2 hover:bg-gray-800">
                Save Changes
            </button>
