...
const Shipping = () => {
    ...
    return (
        ...
        <div className="border border-gray-300 items-center w-full font-semibold">
            ...
            <div className="border-t-2 border-gray-300 items-center w-full flex-col px-5 pt-5">
                <p>Shipping</p>
                ...
                <RadioInput
                    ...
                    inputName={'express'}
                />
                <p className="pt-5">Shipping to <span className="font-bold">{shipping.town}</span></p>
                <button type={"button"} className="flex flex-row w-full py-5" onClick={handleOnClick}>
                <svg className="svg-icon" viewBox="0 0 20 20" width="20" height="20">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                         className="bi bi-chevron-down my-auto pl-2" viewBox="0 0 16 16">
            ...
            <button className="bg-black w-full items-center text-white py-4 mt-4 hover:bg-gray-800">
                Proceed to checkout
            </button>
        </form>
    );
